...
function setup_test_mission()
    ...
    add(game_map[0][3].units, make_unit("1a","1st a squad", "-1", "long",3,0))
    add(game_map[0][3].units, make_unit("2a","2nd a squad", "-1", "long",3,0))
    add(game_map[0][3].units, make_unit("3a","3rd a squad", "-1", "long",3,0))    
    add(game_map[1][3].units, make_unit("hb","hq b platoon", "-1", "short",1,0))
    add(game_map[1][3].units, make_unit("1b","1st b squad", "-1", "long",3,0))
    add(game_map[1][3].units, make_unit("2b","2nd b squad", "-1", "long",3,0))
    add(game_map[1][3].units, make_unit("3b","3rd b squad", "-1", "long",3,0))    
    add(game_map[2][3].units, make_unit("hc","hq c platoon", "-1", "short",1,0))
    add(game_map[2][3].units, make_unit("1c","1st c squad", "-1", "long",3,0))
    add(game_map[2][3].units, make_unit("2c","2nd c squad", "-1", "long",3,0))
    add(game_map[2][3].units, make_unit("3c","3rd c squad", "-1", "long",3,0))    
    add(game_map[0][3].units, make_unit("xo","executive officer", "-1", "short",1,0))
    add(game_map[1][3].units, make_unit("co","commander", "-1", "short",1,0))
    add(game_map[2][3].units, make_unit("sg","first sergeant", "-1", "short",1,0))    
    add(game_map[0][3].units, make_unit("w1","LMG team", "-2", "long",1,0))
    add(game_map[1][3].units, make_unit("w2","LMG team", "-2", "long",1,0))
    add(game_map[0][3].units, make_unit("m1","1st mortar team", "-3", "long",1,0))
    add(game_map[1][3].units, make_unit("m2","2nd mortar team", "-3", "long",1,0))
    add(game_map[2][3].units, make_unit("m3","3rd mortar team", "-3", "long",1,0))
    add(game_map[0][3].units, make_unit("a1","1st bazooka team", "-3", "close",1,0))
    add(game_map[1][3].units, make_unit("a2","2nd bazooka team", "-3", "close",1,0))
    add(game_map[2][3].units, make_unit("a3","3rd bazooka team", "-3", "close",1,0))

    -- Load enemy unit packages
