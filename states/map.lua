...
function setup_test_mission()
    ...
    add(game_map[1][3].units, make_unit("1b","1st b squad", "-1", "short",3,0))
    add(game_map[1][3].units, make_unit("2b","2nd b squad", "-1", "short",3,0))
    add(game_map[1][3].units, make_unit("3b","3rd b squad", "-1", "short",3,0))    
    add(game_map[2][3].units, make_unit("hc","hq c platoon", "-1", "short",1,0))
    add(game_map[2][3].units, make_unit("1c","1st c squad", "-1", "short",3,0))
    add(game_map[2][3].units, make_unit("2c","2nd c squad", "-1", "short",3,0))
    add(game_map[2][3].units, make_unit("3c","3rd c squad", "-1", "short",3,0))    add(game_map[0][3].units, make_unit("ha","hq a platoon", "-1", "short",1,0))
    add(game_map[0][3].units, make_unit("xo","executive officer", "-1", "short",3,0))
    add(game_map[1][3].units, make_unit("co","commander", "-1", "short",3,0))
    add(game_map[2][3].units, make_unit("sg","first sergeant", "-1", "short",3,0))    
end
